...
0x1A0: ld $t0,-8($fp)
0x1A4: ld $t0,0($t0)
0x1A8: addi $t1,$zero,50
0x1AC: sltu $t0,$t0,$t1
0x1B0: beq $t0,$zero,12[0x1E0]
0x1B4: ld $t0,-16($fp)
0x1B8: addi $t1,$zero,1
0x1BC: add $t0,$t0,$t1
0x1C0: sd $t0,-16($fp)
0x1C4: ld $t0,-8($fp)
0x1C8: ld $t1,-8($fp)
0x1CC: ld $t1,0($t1)
0x1D0: addi $t2,$zero,1
0x1D4: add $t1,$t1,$t2
0x1D8: sd $t1,0($t0)
0x1DC: jal $zero,-15[0x1A0]
0x1E0: ld $t0,-16($fp)
0x1E4: addi $t1,$zero,8
0x1E8: sub $t0,$t1,$t0
0x1EC: addi $t1,$zero,1
0x1F0: sltu $t0,$t0,$t1
0x1F4: beq $t0,$zero,5[0x208]
0x1F8: addi $t0,$zero,1
0x1FC: addi $a0,$t0,0
0x200: jal $zero,5[0x214]
0x204: jal $zero,4[0x214]
0x208: addi $t0,$zero,0
0x20C: addi $a0,$t0,0
0x210: jal $zero,1[0x214]
0x214: addi $sp,$fp,0
0x218: ld $fp,0($sp)
0x21C: addi $sp,$sp,8
0x220: ld $ra,0($sp)
0x224: addi $sp,$sp,8
0x228: jalr $zero,0($ra)
0x22C: nop
0x230: .quad 0x0
