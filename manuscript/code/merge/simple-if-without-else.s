...
0x1CC: sd $t0,-16($fp)
0x1D0: ld $t0,-16($fp)
0x1D4: addi $t1,$zero,42
0x1D8: sub $t0,$t1,$t0
0x1DC: addi $t1,$zero,1
0x1E0: sltu $t0,$t0,$t1
0x1E4: beq $t0,$zero,5[0x1F8]
0x1E8: addi $t0,$zero,1
0x1EC: addi $a0,$t0,0
0x1F0: jal $zero,5[0x204]
0x1F4: jal $zero,4[0x204]
0x1F8: addi $t0,$zero,0
0x1FC: addi $a0,$t0,0
0x200: jal $zero,1[0x204]
0x204: addi $sp,$fp,0
0x208: ld $fp,0($sp)
0x20C: addi $sp,$sp,8
0x210: ld $ra,0($sp)
0x214: addi $sp,$sp,8
0x218: jalr $zero,0($ra)
0x21C: nop
0x220: .quad 0x0
